...
1. Copy the provider-driven data contract `orders_v2.odcs.yaml` as a starting point to `orders_v2.consumer_controlling.odcs.yaml` (data: [`orders_v2`](/data/orders_v2/))
